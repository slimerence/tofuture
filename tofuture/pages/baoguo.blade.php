...
@section('content')
    <section class="inner-intro dark-bg bg-image overlay-dark40 " data-background-img="{{ url('images/tofuture/full/absbanner8.jpg') }}" style="background-size: cover;background-position: center center">
        <div class="container">
            <div class="title">
                <h1 class="h2" style="font-size: 3rem;text-shadow: 2px 2px 4px #000c;">CFA考试 CFA 全托管式集训营</h1>
                <h2 class="h3" style="text-shadow: 2px 2px 4px #000c;">CFA保过计划 | CFA 考试 | CFA 课程</h2>
